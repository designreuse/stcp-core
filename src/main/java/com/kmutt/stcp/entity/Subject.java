...
public class Subject implements java.io.Serializable {
    ...
    public Subject(String subjectCode, String nameThai, String nameEng, String subjectType, String credit, Integer status, String detailThai, String detailEng, Set courses, Set prerequisitesForSubjectId, Set prerequisitesForPresubjectId, Set curriculumSubjects, Set coursePlans) {
    ...
    public void setPrerequisitesForSubjectId(Set<Prerequisite> prerequisitesForSubjectId) {
        this.prerequisitesForSubjectId = prerequisitesForSubjectId;
    }

    @OneToMany(fetch = FetchType.LAZY, mappedBy = "subjectByPresubjectId")
    public Set<Prerequisite> getPrerequisitesForPresubjectId() {
        return this.prerequisitesForPresubjectId;
    }

    public void setPrerequisitesForPresubjectId(Set<Prerequisite> prerequisitesForPresubjectId) {
        this.prerequisitesForPresubjectId = prerequisitesForPresubjectId;
    }
